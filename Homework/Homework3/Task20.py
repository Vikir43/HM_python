...
rus = {1: 'А, В, Е, И, Н, О, Р, С, Т', 2: 'Д, К, Л, М, П, У' , 3: ' Б, Г, Ё, Ь, Я ', 4: 'Й, Ы', 5: 'Ж, З, Х, Ц, Ч', 8: 'Ш, Э, Ю', 10: 'Ф, Щ, Ь'}
lang = int(input('Введите 1 если в игре слово на английском языке, 0 если на русском: '))
word = str(input('Введите слово: '))
if lang == 1:
   print(f'Вы получили', sum([k for i in word for k, v in eng.items() if i in v]), 'очков')
else:
   print(f'Вы получили', sum([k for i in word for k, v in rus.items() if i in v]), 'очков')
